...
* Satisfies all of the preceding acceptance criteria plus the following code improvements:
  ...
  * Application's CSS selectors and properties are consolidated and organized to follow semantic structure. **TODO**

  * Application's CSS file is properly commented. **TODO**
...
* Application resembles mock-up provided in the homework instructions (at least 90%). **DONE**
